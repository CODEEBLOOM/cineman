...
public class SnacksController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<ApiResponse> getSnackById(@PathVariable @Min(1) int id) {
        return ResponseEntity.ok(
                ApiResponse.builder()
                        .message("Lấy thông tin snack thành công.")
                        .status(HttpStatus.OK.value())
    ...
    @PutMapping("/{id}")
    public ResponseEntity<ApiResponse> updateSnack(@PathVariable @Min(1) int id,
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<ApiResponse> deleteSnack(@PathVariable @Min(1) int id) {
