...
public class GlobalExceptionHandler {
    ...
    /**
     * Handler Exception data not found
            ...
            @ApiResponse(responseCode = "404", description = "Bad Request",
                    content = {@Content(mediaType = APPLICATION_JSON_VALUE,
                            examples = @ExampleObject(
                                    name = "404 Response",
                                    summary = "Handle exception when data not found",
                                    value = """
                                            {
                                              "timestamp": "2025-06-19T06:07:35.321+00:00",
                                              "status": 404,
                                              "path": "/api/v1/...",
                                              "error": "Not Found",
    ...
    public ErrorResponse handleResourceNotFoundException(DataNotFoundException e, WebRequest request) {
    ...
    public ErrorResponse handleDataExitingException(DataExistingException e, WebRequest request) {
        ErrorResponse errorResponse = new ErrorResponse();
        errorResponse.setTimestamp(new Date());
        errorResponse.setPath(request.getDescription(false).replace("uri=", ""));
